...
- The site is built with the [Vue 3](https://vuejs.org/) framework, using its Composition API, which in my experience is intuitive, reliable, and which suits perfectly the fundamentals of "atomic design".
